...
exports.deleteAll = (req, res) => {
  res.locals.haproxy.clearCounters(true).then(() => res.end()).catch(reason => res.status(400).send(reason));
};
...
exports.deleteCounters = (req, res) => {
  res.locals.haproxy.clearCounters().then(() => res.end()).catch(reason => res.status(400).send(reason));
};
...
exports.getDescription = (req, res) => {
  res.locals.haproxy.description().then(description => res.json(description)).catch(reason => res.status(400).send(reason));
};
...
exports.getErrors = (req, res) => {
  res.locals.haproxy.errors().then(errors => res.json(errors)).catch(reason => res.status(400).send(reason));
};
...
exports.getInfo = (req, res) => {
  res.locals.haproxy.info().then(info => res.json(info)).catch(reason => res.status(400).send(reason));
};
...
exports.getMaxconn = (req, res) => {
  res.locals.haproxy.maxConn().then( maxConn => res.json(maxConn)).catch(reason => res.status(400).send(reason));
};
...
exports.getMetric = (req, res) => {
  res.locals.haproxy.metric(req.params.name).then( metric => res.json(metric)).catch(reason => res.status(400).send(reason));;
};
...
exports.getNodeName = (req, res) => {
  res.locals.haproxy.nodeName().then(nodeName => res.json(nodeName)).catch(reason => res.status(400).send(reason));
};
...
exports.getPids = (req, res) => {
  res.locals.haproxy.processIds().then( pids => res.json(pids)).catch(reason => res.status(400).send(reason));
};
...
exports.getReleaseDate = (req, res) => {
  res.locals.haproxy.releaseDate().then(releaseDate => res.json(releaseDate)).catch(reason => res.status(400).send(reason));
};
...
exports.getRequests = (req, res) => {
  res.locals.haproxy.requests().then(requests => res.json(requests)).catch(reason => res.status(400).send(reason));
};
...
exports.getUptime = (req, res) => {
  res.locals.haproxy.uptime().then(uptime => res.json(uptime)).catch(reason => res.status(400).send(reason));
};
...
exports.getVersion = (req, res) => {
  res.locals.haproxy.version().then(version => res.json(version)).catch(reason => res.status(400).send(reason));
};
...
exports.patchMaxconn = (req, res) => {
  ...
  Promise.all(promises).then( () => res.status(204).end()).catch(reason => res.status(400).send(reason));
};
...
exports.patchRateLimits = (req, res) => {
  ...
  if (req.body['sslSessions']) {
    promises.push(res.locals.haproxy.setRateLimitSSLSession(req.body['sslSessions']));
  }
  Promise.all(promises).then( () => res.status(204).end()).catch(reason => res.status(400).send(reason));
};
